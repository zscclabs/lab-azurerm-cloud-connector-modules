...
resource "tls_private_key" "key" {
  count     = var.ssh_key_file == null ? 1 : 0
...
# Use provided key file or generated key
locals {
  ssh_key = var.ssh_key_file != null ? file(var.ssh_key_file) : tls_private_key.key[0].public_key_openssh
}
