...
variable "ssh_key_file" {
  type        = string
  description = "Path to SSH public key file (e.g., ~/.ssh/id_rsa.pub). If not provided, a new RSA key will be generated automatically (not recommended for production)."
  default     = null
}
